...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        Description :   This method initiates the model pusher component.
                         It uploads the trained model to S3 if it was accepted.
        ...
        try:
            logging.info("Uploading model artifact to S3 bucket")

            self.usvisa_estimator.save_model(
                from_file=self.model_evaluation_artifact.trained_model_path, remove=False
            )
